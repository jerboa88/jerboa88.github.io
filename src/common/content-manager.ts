...
function getFilteredSkillsOfType(
	...
	const skillSets: {
		[EntryVisibility.Pin]: Set<Skill>;
		[EntryVisibility.Show]: Set<Skill>;
		[EntryVisibility.Hide]: Set<Skill>;
	} = {
		[EntryVisibility.Pin]: new Set(),
		[EntryVisibility.Show]: new Set(),
		[EntryVisibility.Hide]: new Set(),
	};
	const visibilityTypes = Object.keys(skillSets) as EntryVisibility[];
...
export function getSkillsForPage(pagePath: string) {
	...
	const skillTypes = Object.keys(skillSubsets) as SkillType[];
