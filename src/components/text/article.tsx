...
export function Article({ className = '', children, html }: ArticlePropsInterface) {
	...
	const linkStyles = 'prose-a:no-underline prose-a:pb-0.5 [&:not(.anchor)]:prose-a:border-b-[1px] prose-a:transition-colors prose-a:font-semibold prose-a:border-primary hover:prose-a:border-secondary';
